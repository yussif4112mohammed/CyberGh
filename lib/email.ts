          ...
          <tr>
            <td style="background: white; padding: 32px;">
              ...
              ">
                ...
                <a href="https://scanvault-gh.vercel.app/contact" style="
                  display: inline-block;
                  background: #C8102E;
                  color: white;
                  text-decoration: none;
          ...
          <tr>
            ...
            ">
              <div style="color: #94A3B8; font-size: 12px; line-height: 1.6;">
                ...
                <a href="https://scanvault-gh.vercel.app" style="color: #0A1628; text-decoration: none; font-weight: 600;">scanvault-gh.vercel.app</a>
                &nbsp;·&nbsp;
                <a href="https://scanvault-gh.vercel.app/privacy" style="color: #94A3B8; text-decoration: none;">Privacy Policy</a>
                &nbsp;·&nbsp; Made in Ghana 🇬🇭
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="background: #F4F6FA; border-radius: 0 0 16px 16px; padding: 20px 32px; text-align: center;">
              <div style="color: #94A3B8; font-size: 12px; line-height: 1.6;">
                ...
                <a href="https://scanvault-gh.vercel.app" style="color: #0A1628; text-decoration: none; font-weight: 600;">scanvault.app</a>
                &nbsp;·&nbsp; Made in Ghana 🇬🇭
              </div>
            </td>
          </tr>
